...
public class EmitirLicenciaController implements Initializable {
    ...
    private void ImprimirLicencia() {
        ...
        try (PDDocument documentLicencia = new PDDocument();
            ...
            try (PDPageContentStream contentStreamComprobante = new PDPageContentStream(documentComprobante, pageComprobante)) {
    ...
    private void drawLicencia(PDPageContentStream contentStreamLicencia, PDDocument documentLicencia) throws IOException {
        float marginLeft = 50;
        float marginTop = 750;
        float width = 500;
        float height = 250;
        ...
        PDImageXObject image = PDImageXObject.createFromByteArray(documentLicencia, imageStream.readAllBytes(), "foto.png");
        ...
        drawRoundedRectangle(contentStreamLicencia, marginLeftDorso, marginTopDorso - heightDorso, widthDorso, heightDorso, radiusDorso);
    ...
    private void addText(PDPageContentStream contentStream, String text, float x, float y, int fontSize) throws IOException {
        addText(contentStream, text, x, y, fontSize, false);
    }

    private void addText(PDPageContentStream contentStream, String text, float x, float y, int fontSize, boolean bold) throws IOException {
        contentStream.beginText();
        contentStream.setFont(new PDType1Font(bold ? Standard14Fonts.FontName.TIMES_BOLD : Standard14Fonts.FontName.TIMES_ROMAN), fontSize);
